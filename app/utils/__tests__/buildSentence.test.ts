...
describe("buildSentence", () => {
  ...
  it("returns a sentence with correct verb for singular subject", () => {
    const result = buildSentence((subjectSingular as PostSubject), "controlling", "the weather", engagements)
  ...
  it("generates between 3 and 8 hashtags, each prefixed with #", () => {
    const result = buildSentence((subjectSingular as PostSubject), "testing", "something", engagements)
