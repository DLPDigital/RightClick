...
const AboutPage: React.FC = () => (
  <div className={container}>
    ...
    <p>
      I wish I didn't need to say this, but obviously all posts and anything else, including names,
      events and virtually everything else, are completely fictional and bear no resemblance to
      reality.
    </p>
    <h2>Tech</h2>
    ...
    <p><a href="/" title="Back to the game">Back to the game</a></p>
  </div>
)
