...
function App() {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      setGameState((prev) => {
        ...
        const newFollowers =
          prev.followers + rates.calculatedPassiveFollowersPerSecond * deltaSeconds
        ...
        const newMoney = prev.money + moneyFromFollowers + moneyFromMonetization
  ...
  }, [calculateRates, setGameState]) // Empty dependency array means this runs once on mount
